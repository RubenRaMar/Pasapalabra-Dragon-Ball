...
const chooseQuestionForEachLetter = () =>
  questions.forEach(
    (question) => (question.questionIndex = Math.round(Math.random() * 2))
  );

const getQuestionData = () => {
  questionData.letterPosition = getLetterPosition(
  ...
  questionData.choosenQuestionIndex =
    questionData.choosenQuestion.questionIndex;
